...
public class Movement_Adjuster 
{
    ...
    public boolean isleftcollection(Movement_Adjuster actor)
    {
        if ((this.getX()-space==actor.getX()) &&
    ...
    public boolean isbottomcollision(Movement_Adjuster actor)
    {
        if((this.getY()+space==actor.getY()) &&
                (this.getX()==actor.getX()))
        {
